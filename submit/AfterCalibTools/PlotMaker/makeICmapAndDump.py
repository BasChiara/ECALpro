...
foldername = "AlCaP0_2023BCD_TestCalib_iter4to10"
niter = 5       # generally it starts from 0
eosPi0Folder = "pi0"
...
f1 = "root://eoscms//eos/cms/store/group/dpg_ecal/alca_ecalcalib/{eosfd}/mciprian/{fd}/iter_{n}/{fd}_calibMap.root".format(eosfd=eosPi0Folder,
                                                                                                                           fd=foldername, 
                                                                                                                           n=niter)
f1 = "/eos/cms/store/group/dpg_ecal/comm_ecal/{eosfd}/{fd}/iter_{n}/{fd}_calibMap.root".format(eosfd=eosPi0Folder, fd=foldername, n=niter)
